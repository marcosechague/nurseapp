...
import static py.com.naturabeans.nurseappapi.controller.PatientController.BASE_CONTROLLER_PATH;

@RestController(value = BASE_CONTROLLER_PATH)
public class PatientController {

    static final String BASE_CONTROLLER_PATH = API_VERSION+"/patients";
